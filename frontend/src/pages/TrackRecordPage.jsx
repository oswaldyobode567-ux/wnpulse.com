...
export default function TrackRecordPage() {
  ...
  useEffect(() => {
    ...
    api
      .get(
        `/track-record?page=${page}&per_page=20${sportParam}`
      )
      .then((response) => {
        if (mounted) {
        ...
        if (mounted) {
          ...
          setError(
            err?.response?.data?.detail ||
              "Impossible de charger le Track Record."
          );
        }
      })
      .finally(() => {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-900 via-slate-900 to-orange-900 text-white p-8 sm:p-12 mb-10 ring-1 ring-white/10">
          ...
          <div className="relative text-center">
            ...
            <p className="mt-4 text-slate-300 max-w-2xl mx-auto text-base">
              Les picks officiels sont sélectionnés avant le
              match selon des critères fixes. Les résultats
              confirmés restent affichés, gagnés comme perdus.
            </p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <Card className="p-8 text-center border-rose-200 bg-rose-50">
            <div className="font-heading font-bold text-rose-800 mb-2">
          ...
          <>
              ...
              >
                ...
                <div>
                  <div className="font-heading text-2xl font-black">
                    {stats.current_streak} victoires
                    d'affilée !
                  </div>

                  <div className="text-sm text-white/90">
                    Notre série en cours — vérifiable
            ...
            <Card
              className="bg-white border-neutral-200 p-4 mb-6"
              data-testid="sport-filters"
            >
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <Button
                    ...
                    className={
                      sport === value
                        ? "wp-gradient-warm text-white border-0"
                        : ""
                    }
                  >
                    {label}
            ...
            {stats.by_sport && (
              <Card
                className="bg-white border-neutral-200 p-5 mb-6"
                data-testid="by-sport-stats"
              >
            ...
            >
              <Kpi
                ...
                sub={`${stats.wins ?? 0}/${stats.total ?? 0} picks`}
                accent="emerald"
              />
            ...
            {stats.by_label && (
              <Card
                className="bg-white border-neutral-200 p-5 mb-8"
                data-testid="by-label-stats"
              >
                <h2 className="font-heading font-bold text-slate-900 mb-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {[
                    ...
                    return (
                      ...
                      >
                        <Badge
                          className={`text-[10px] font-bold border mb-2 ${meta.cls}`}
                        >
                          {meta.text}
                        </Badge>
                        ...
                        <div className="text-xs text-slate-500 mt-1">
                          {Number(
                            ...
                            ? `${labelData.wins ?? 0}/${labelData.total} picks résolus`
                ...
                <p className="text-xs text-slate-400 mt-4">
                  Le niveau de confiance (Sûr /
                  Modéré / Risqué) est déterminé
                  avant chaque match, selon des
                  critères fixes — un pick
                  "Risqué" perdu ne reflète pas la
                  fiabilité de nos picks "Sûr".
                </p>
              </Card>
            )}
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-4 py-3 text-center">
                              {meta ? (
                                <Badge
                                  className={`text-[10px] font-bold border ${meta.cls}`}
                                >
                                  {meta.text}
                                </Badge>
                              ) : (
            ...
            <div className="mt-10 text-center">
              <h3 className="font-heading text-2xl font-extrabold text-slate-900 mb-2">
                Découvre les picks officiels
              </h3>

              <p className="text-slate-600 mb-4">
                Rejoins les abonnés Pro pour
                avoir tous nos picks chaque jour.
              </p>

              <Link to="/register">
                <Button className="wp-gradient-warm text-white border-0 h-12 px-8 text-base">
                  Démarrer gratuit
                </Button>
              </Link>
            </div>
...
function Kpi({
  ...
  return (
    <Card className="bg-white border-neutral-200 p-4">
      <div
        className={`h-8 w-8 rounded-lg grid place-items-center border ${cls} mb-3`}
      >
      ...
      <div
        className={`font-heading text-2xl font-extrabold text-slate-900 ${
          mono ? "font-mono" : ""
        }`}
      >
        {value}
